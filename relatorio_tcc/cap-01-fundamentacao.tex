...
de pesquisa. O \textbf{Azure Kinect DK}, sucessor direto lançado em
...
A família \textbf{Intel RealSense} (modelos D400), por sua vez, emprega
\textit{visão estéreo ativa}: um par de câmeras infravermelhas associado
...
O modelo de Tsai~\cite{tsai1987versatile} estende o
...
\textbf{mínimos quadrados}: minimiza a soma dos quadrados das distâncias
...
O algoritmo \textbf{RANSAC} (\textit{Random Sample Consensus}), proposto
por Fischler e Bolles~\cite{fischler1981random}, resolve esse problema por
...
número de \textbf{inliers} — pontos da nuvem inteira cuja distância ao
...
Neste trabalho, o RANSAC não substitui o SVD, mas o \textbf{precede}: o
