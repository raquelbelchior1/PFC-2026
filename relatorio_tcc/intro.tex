...
malha discretizada de quadrados coloridos, de modo a comparar, célula a 
célula, o relevo medido por um sensor óptico de profundidade com o relevo
de referência extraído de um arquivo GeoTIFF. Além disso, o sistema deverá
operar em modalidade \textit{plug and play}, iniciando automaticamente ao ser conectado
e, caso seja detectada alguma falha no sensor ou em seus componentes, alternando
automaticamente para um emulador interativo.
...
geométrica completa~\mbox{SVD + Gram-Schmidt + Tsai}, (ii) a regra
