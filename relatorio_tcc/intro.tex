...
Os \textbf{caixões de areia com realidade aumentada} — na literatura
...
língua portuguesa \emph{caixão de areia com realidade aumentada}.
...
\textbf{Seção de Simulação da Academia Militar das Agulhas Negras (AMAN)}
mantém, em sua \textbf{Área de Emissão de Ordens Tecnológicas}, um caixão
